...
--       true,
--       false,
--       'https://s3.us-east-2.amazonaws.com/dailykit.org/notif.mp3',
--       'WEBHOOK_DEFAULT_NOTIFICATION_HANDLER'
--    ),
--    (
...
--    (1019, 'email', 'Email Notification') (1020, 'brand', 'Policy Availability'),
--    (1021, 'brand', 'Terms and Conditions'),
--    (1022, 'availability', 'Store Availability'),
--    (1023, 'brand', 'Privacy Policy'),
--    (1024, 'brand', 'Refund Policy'),
--    (1025, 'email', 'Subscription Reminder Email'),
--    (1026, 'sales', 'Statement Descriptor'),
--    (1027, 'App', 'scripts'),
--    (1028, 'App', 'seo');
...
--    ),
--    (1000, 1021, '{"value":""}'),
--    (1000, 1022, '{"isStoreLive": false}'),
--    (1000, 1023, '{"value":""}'),
--    (1000, 1024, '{"value":""}'),
--    (
--       1000,
--       1025,
--       '{"name": "Test","email": "no-reply@dailykit.org","template": {  "data": {  "fileName": "{{data.fileName}}", "brand_customerId": "{{data.brand_customerId}}", "subscriptionOccurenceId": "{{data.subscriptionOccurenceId}}"  }, "template": { "name": "reminder", "type": "email/order/customer/subscription", "format": "html"  }} }'
--    ),
--    (1000, 1026, '{"value": ""}'),
--    (
--       1000,
--       1027,
--       '{ "endBody": [], "endHead": [], "startBody": [], "startHead": [] }'
--    ),
--    (
--       1000,
--       1028,
--       '{"/": {  "image": "",  "title": "Home",  "description": "A subscription based meal kit store"},"/login": {  "image": "",  "title": "Login",  "description": ""},"/pricing": {  "image": "",  "title": "Pricing",  "description": "Pricing for different subscription plans"},"/our-menu": {  "image": "",  "title": "Our Menu",  "description": "The menu for subscription based meal kit store"},"/register": {  "image": "",  "title": "Register",  "description": ""},"/how-it-works": {  "image": "",  "title": "How It Works",  "description": ""}        }'
--    ),
-- ;
-- --  STORE BRAND SETTING 
...
--    (28, 'sales', 'Tax Percentage'),
--    (29, 'brand', 'Statement Descriptor');
