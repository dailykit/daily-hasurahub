...
ALTER COLUMN id
SET DEFAULT nextval('"order".cart_rewards_id_seq'::regclass);
...
ALTER TABLE ONLY "order".cart_rewards ADD CONSTRAINT cart_rewards_pkey PRIMARY KEY (id);


ALTER TABLE ONLY "order".cart ADD CONSTRAINT "cart_subscriptionOccurenceId_brandId_customerKeycloakId_key" UNIQUE ("subscriptionOccurenceId",
                                                                                                                   "brandId",
                                                                                                                   "customerKeycloakId");
...
ALTER TABLE ONLY rules.facts ADD CONSTRAINT facts_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY website."navigationMenuItem" ADD CONSTRAINT "navigationMenuItem_pkey" PRIMARY KEY (id);


ALTER TABLE ONLY website."navigationMenu" ADD CONSTRAINT "navigationMenu_pkey" PRIMARY KEY (id);
...
ALTER TABLE ONLY crm."orderCart_rewards"
    ADD CONSTRAINT "orderCart_rewards_orderCartId_fkey" FOREIGN KEY ("orderCartId") REFERENCES "order".cart(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY crm."orderCart_rewards"
