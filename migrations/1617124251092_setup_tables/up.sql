...
CREATE TABLE products."customizableProductComponent" (
        id integer DEFAULT public.defaultid(
                'products' :: text,
                'customizableProductComponent' :: text,
                'id' :: text
        ) NOT NULL,
        created_at timestamp with time zone DEFAULT now(),
        updated_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE rules.conditions (
        ...
        condition jsonb DEFAULT jsonb_build_object() NOT NULL,
        app text
);
...
CREATE TABLE subscription."subscriptionOccurence_addOn" (
        id integer DEFAULT public.defaultid(
                'subscription' :: text,
                'subscriptionOccurence_addOn' :: text,
                'id' :: text
        ) NOT NULL,
        "subscriptionOccurenceId" integer,
...
CREATE TABLE subscription."subscriptionOccurence_product" (
        ...
        id integer DEFAULT public.defaultid(
                'subscription' :: text,
                'subscriptionOccurence_product' :: text,
                'id' :: text
        ) NOT NULL,
        created_at timestamp with time zone DEFAULT now(),
        updated_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE inventory."supplierItem_unitConversion" (
        id integer DEFAULT public.defaultid(
                'inventory' :: text,
                'supplierItem_unitConversion' :: text,
                'id' :: text
        ) NOT NULL,
        "entityId" integer NOT NULL,
        "unitConversionId" integer NOT NULL
...
CREATE TABLE "onDemand"."collection_productCategory" (
        id integer DEFAULT public.defaultid(
                'onDemand' :: text,
                'collection_productCategory' :: text,
                'id' :: text
        ) NOT NULL,
        "collectionId" integer NOT NULL,
...
CREATE TABLE products."productConfigTemplate" (
        id integer DEFAULT public.defaultid(
                'products' :: text,
                'productConfigTemplate' :: text,
                'id' :: text
        ) NOT NULL,
        template jsonb NOT NULL,
        "isDefault" boolean,
...
CREATE TABLE products."productDataConfig" (
        "productId" integer NOT NULL,
