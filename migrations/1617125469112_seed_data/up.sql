...
-- FULFILMENT TYPE
INSERT INTO fulfilment."fulfillmentType" (value, "isActive")
VALUES ('ONDEMAND_DELIVERY', true),
...
VALUES ('LABEL_PRINTER'),
   ...
   ('KOT_PRINTER');
-- MODE OF FULFILLMENT
INSERT INTO ingredient."modeOfFulfillmentEnum" (value, description)
VALUES ('realTime', 'realm time'),
...
--  STORE BRAND SETTING 
INSERT INTO brands."storeSetting" (id, type, identifier)
VALUES (1, 'brand', 'Brand Logo'),
   (2, 'visual', 'Favicon'),
   (3, 'visual', 'App Title'),
...
INSERT INTO brands."brand_storeSetting" ("brandId", "storeSettingId", value)
VALUES (
      1000,
      1,
   ...
   (
      1000,
      13,
      '{"name":"Test","email":"no-reply@dailykit.org","template":{"data":{"id":"{{new.id}}"},"template":{"name":"new","type":"email/order/customer","format":"html"}}}'
   ),
   (
      1000,
      14,
   ...
   (
      1000,
      26,
      '{ "name": "Test", "email": "no-reply@dailykit.org", "template": { "data": { "id": "{{new.id}}" }, "template": { "name": "delivered", "type": "email/order/customer", "format": "html" } } }'
   ),
   (
      1000,
      27,
      '{ "name": "Test", "email": "no-reply@dailykit.org", "template": { "data": { "id": "{{new.id}}" }, "template": { "name": "cancelled", "type": "email/order/customer", "format": "html" } } }'
   );
-- APPS LISTING
INSERT INTO settings.app (id, title, route, icon)
VALUES (
      1,
      'Orders',
      '/order',
...
--  ORDER APP SETTINGS
INSERT INTO settings."appSettings" (id, app, "type", identifier, value)
VALUES (
      1,
      'order',
      'scale',
...
-- ADMIN ROLE
INSERT INTO settings."role" (id, title)
VALUES (1, 'admin');
-- APPS ROLES
INSERT INTO settings."role_app" (id, "roleId", "appId")
VALUES (1, 1, 1),
   (2, 1, 2),
   (3, 1, 3),
   (4, 1, 4),
...
VALUES (1, 1000, true),
   ...
   (9, 1065, true);
-- CRM CAMPAIGNS
INSERT INTO crm."campaignType" (id, value)
VALUES (1, 'Sign Up'),
   (2, 'Referral'),
   (3, 'Post Order');
-- CRM REWARDS
INSERT INTO crm."rewardType" (id, value, "useForCoupon", handler)
VALUES (1, 'Loyalty Point Credit', true, 'jaguar'),
   (2, 'Wallet Amount Credit', true, 'jaguar'),
   (3, 'Discount', true, 'cart');
-- CRM CAMPAIGN REWARDS
INSERT INTO crm."rewardType_campaignType" ("rewardTypeId", "campaignTypeId")
VALUES (1, 1),
   (2, 1),
   (1, 2),
   (2, 2),
